...
class GreetServicer(greet_pb2_grpc.GreeterServicer):
    def SayHello(self, request, context):
        ...
        print("PRINTING THE MESSAGE: " + hello_reply.message)
        return hello_reply
    
    def ParrotSaysHello(self, request, context):
        print("ParratSaysHello Request Made")
        print(request)
    ...
    def ChattyClientSaysHello(self, request_iterator, context):
        ...
        delayed_reply.message = f"You have sent {len(delayed_reply.request)} message. Please expect a delay reply"
